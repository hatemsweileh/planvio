...
{{--
    The Planvio mark, inlined rather than linked.

    An <img> cannot inherit the surrounding text colour, and this mark is drawn in two
    inks: the arrow takes the workspace accent, the wordless "P" takes whatever the text
    colour is where it sits. That is what lets the same file sit on a white card and on a
    dark canvas without a second asset.
--}}
<svg {{ $attributes->merge(['class' => 'size-8', 'viewBox' => '0 0 300.71 365.36']) }}
